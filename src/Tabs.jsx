...
function Tabs({ onChange }) {
    ...
    const selectedClass = "inline-flex items-center justify-center p-4 text-blue-600 border-b-2 border-blue-600 rounded-t-lg active dark:text-blue-500 dark:border-blue-500 group";
    ...
    return <div class="border-b border-gray-200">
        <ul class="flex -mb-px text-sm font-medium text-gray-500">
            ...
            <li class="me-2" onClick={() => onItemClick(2)}>
                <a href="#" className={selected === 2 ? selectedClass : unSelectedClass}>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
