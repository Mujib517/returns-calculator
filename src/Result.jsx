...
function Result({ data }) {
    ...
    return <div className="w-full max-w-lg p-6 bg-white rounded-lg shadow-lg">
        ...
        <div className="space-y-4">
            {/* Invested Amount */}
            <div className="flex items-center justify-between bg-blue-100 text-blue-800 px-4 py-4 rounded-md">
            ...
            {/* Returns */}
            <div className="flex items-center justify-between bg-green-100 text-green-800 px-4 py-4 rounded-md">
